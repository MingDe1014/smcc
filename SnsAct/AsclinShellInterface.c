...
boolean AppShell_vadcbg1(pchar args, void *data, IfxStdIf_DPipe *io){
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  Ch4(LEFT_LONG): %4.2f,",IR_getUsrAdcChn0());
    	IfxStdIf_DPipe_print(io, "  Ch5(RIGHT_SHORT): %4.2f,",IR_getUsrAdcChn1());
    	//IfxStdIf_DPipe_print(io, "  Ch6: %4.2f,",IR_getUsrAdcChn2());
    	//IfxStdIf_DPipe_print(io, "  Ch7: %4.2f,"ENDL,IR_getUsrAdcChn3());
